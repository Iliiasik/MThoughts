...
public class SleepOverlayRenderer {
    private static final Identifier SKULL_TEXTURE = Identifier.fromNamespaceAndPath(MTConstants.MOD_ID, "textures/gui/shared/overlay/skull.png");

    private static final Identifier[] MOON_PHASE_TEXTURES = {
            Identifier.fromNamespaceAndPath(MTConstants.MOD_ID, "textures/gui/shared/overlay/moon_phases/full_moon.png"),
            Identifier.fromNamespaceAndPath(MTConstants.MOD_ID, "textures/gui/shared/overlay/moon_phases/waning_gibbous.png"),
            Identifier.fromNamespaceAndPath(MTConstants.MOD_ID, "textures/gui/shared/overlay/moon_phases/last_quarter.png"),
            Identifier.fromNamespaceAndPath(MTConstants.MOD_ID, "textures/gui/shared/overlay/moon_phases/waning_crescent.png"),
            Identifier.fromNamespaceAndPath(MTConstants.MOD_ID, "textures/gui/shared/overlay/moon_phases/new_moon.png"),
            Identifier.fromNamespaceAndPath(MTConstants.MOD_ID, "textures/gui/shared/overlay/moon_phases/waxing_crescent.png"),
            Identifier.fromNamespaceAndPath(MTConstants.MOD_ID, "textures/gui/shared/overlay/moon_phases/first_quarter.png"),
            Identifier.fromNamespaceAndPath(MTConstants.MOD_ID, "textures/gui/shared/overlay/moon_phases/waxing_gibbous.png")
    };
    ...
    private void onSleepStart() {
        MTClientNetwork.sendToServer(new RequestMoonPhasePacket());
    ...
    private void renderOverlay(GuiGraphicsExtractor context, int w, int h) {
    ...
    static void fillHorizontalGradient(GuiGraphicsExtractor context, int x1, int x2, int y2, int alphaLeft, int alphaRight, int rgb) {
        int step = 3;
        int width = x2 - x1;
        if (width <= 0) return;
    ...
    private void renderContent(GuiGraphicsExtractor context, int w, int h) {
    ...
    private void renderImage(GuiGraphicsExtractor context, int x, int y, int size) {
    ...
    private void drawLayout(GuiGraphicsExtractor context, Font font, TextLayout layout, int centerX, int top, int lineHeight, float alpha01) {
        ...
        for (int i = 0; i < lines.size(); i++) {
            ...
            context.text(font, line, -lineWidth / 2, i * lineHeight, textColor, true);
        }
        context.pose().popMatrix();
    }

    private void drawProgress(GuiGraphicsExtractor context, int centerX, int y, float uiScale, float frac) {
