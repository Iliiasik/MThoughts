...
public final class ClientPacketHandlers {
    ...
    public static void handleUserContent(UserContentPacket packet) {
        if (MTClient.userContent() != null) {
            MTClient.userContent().applyServerContent(packet.content());
        }
    }
    ...
    public static void handleMoonPhase(MoonPhasePacket packet) {
        if (MTClient.overlay() != null) {
            MTClient.overlay().setMoonPhase(packet.moonPhase());
        }
    }
}
