...
public class WellRestedClientState {
    ...
    public static void update(boolean active, int level, int ticksRemaining, int totalTicks, int phase, boolean nightmareMode, boolean mvp) {
        ...
        WellRestedClientState.phase = phase;
    ...
    public static float getProgress() {
        ...
        return (float) ticksRemaining / totalTicks;
    }
}