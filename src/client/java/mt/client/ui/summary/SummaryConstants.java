...
public class SummaryConstants {
    ...
    public static final Identifier ICON_BLOCKS = Identifier.of(MidnightThoughtsClient.MOD_ID, "textures/gui/shared/icons/icon_blocks.png");
    public static final Identifier ICON_DISTANCE = Identifier.of(MidnightThoughtsClient.MOD_ID, "textures/gui/shared/icons/icon_distance.png");
    public static final Identifier ICON_SWORD = Identifier.of(MidnightThoughtsClient.MOD_ID, "textures/gui/shared/icons/icon_sword.png");
    public static final Identifier ICON_DEATH = Identifier.of(MidnightThoughtsClient.MOD_ID, "textures/gui/shared/icons/icon_death.png");
    public static final Identifier ICON_JUMP = Identifier.of(MidnightThoughtsClient.MOD_ID, "textures/gui/shared/icons/icon_jump.png");
    public static final Identifier ICON_AXE = Identifier.of(MidnightThoughtsClient.MOD_ID, "textures/gui/shared/icons/icon_axe.png");
