...
public class FrameRenderer {
    ...
    public static void render(GuiGraphicsExtractor graphics, SummaryDimensions dims, float fadeAlpha) {
        RenderHelper.blitTexture(graphics, SummaryConstants.getFrameTexture(),
    ...
    public static void renderBadge(GuiGraphicsExtractor graphics, Font font, SummaryDimensions dims, float fadeAlpha) {
        ...
        RenderHelper.blitTexture(graphics, SummaryConstants.getBadgeTexture(),
        ...
        RenderUtils.renderCenteredScaledText(graphics, font, title,
    ...
    public static void renderPagesHolder(GuiGraphicsExtractor graphics, Font font, SummaryDimensions dims,
        ...
        RenderHelper.blitTexture(graphics, SummaryConstants.getPagesHolderTexture(),
        ...
        RenderUtils.renderCenteredScaledText(graphics, font, pageInfo,
