...
public class PlayerRowRenderer {
    ...
    private static void renderMvpBadge(DrawContext context, int x, int y, int rowWidth, SummaryDimensions dims, float fadeAlpha) {
        ...
        int color = (int) (fadeAlpha * 255) << 24 | 0xFFFFFF;
        context.drawTexture(RenderPipelines.GUI_TEXTURED, SummaryConstants.CROWN_TEXTURE,
                iconX, iconY, 0.0f, 0.0f, iconWidth, iconHeight, iconWidth, iconHeight, iconWidth, iconHeight, color);
    }
