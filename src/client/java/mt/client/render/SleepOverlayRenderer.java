...
public class SleepOverlayRenderer {
    private static final ResourceLocation SKULL_TEXTURE = new ResourceLocation(MidnightThoughtsClient.MOD_ID, "textures/gui/shared/overlay/skull.png");

    private static final ResourceLocation[] MOON_PHASE_TEXTURES = {
            new ResourceLocation(MidnightThoughtsClient.MOD_ID, "textures/gui/shared/overlay/moon_phases/full_moon.png"),
            new ResourceLocation(MidnightThoughtsClient.MOD_ID, "textures/gui/shared/overlay/moon_phases/waning_gibbous.png"),
            new ResourceLocation(MidnightThoughtsClient.MOD_ID, "textures/gui/shared/overlay/moon_phases/last_quarter.png"),
            new ResourceLocation(MidnightThoughtsClient.MOD_ID, "textures/gui/shared/overlay/moon_phases/waning_crescent.png"),
            new ResourceLocation(MidnightThoughtsClient.MOD_ID, "textures/gui/shared/overlay/moon_phases/new_moon.png"),
            new ResourceLocation(MidnightThoughtsClient.MOD_ID, "textures/gui/shared/overlay/moon_phases/waxing_crescent.png"),
            new ResourceLocation(MidnightThoughtsClient.MOD_ID, "textures/gui/shared/overlay/moon_phases/first_quarter.png"),
            new ResourceLocation(MidnightThoughtsClient.MOD_ID, "textures/gui/shared/overlay/moon_phases/waxing_gibbous.png")
    };
