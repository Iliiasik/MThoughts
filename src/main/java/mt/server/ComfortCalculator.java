...
public class ComfortCalculator {
    ...
    private static final TagKey<Block> LIGHTING_TAG = TagKey.create(Registries.BLOCK, new ResourceLocation("midnightthoughts", "comfort_lighting"));
    private static final TagKey<Block> CARPET_TAG = TagKey.create(Registries.BLOCK, new ResourceLocation("midnightthoughts", "comfort_carpet"));
    private static final TagKey<Block> FURNITURE_TAG = TagKey.create(Registries.BLOCK, new ResourceLocation("midnightthoughts", "comfort_furniture"));
    private static final TagKey<Block> DECOR_TAG = TagKey.create(Registries.BLOCK, new ResourceLocation("midnightthoughts", "comfort_decoration"));
    private static final TagKey<Block> STRUCTURE_TAG = TagKey.create(Registries.BLOCK, new ResourceLocation("midnightthoughts", "comfort_structure"));
    private static final TagKey<Block> NEGATIVE_MACABRE_TAG = TagKey.create(Registries.BLOCK, new ResourceLocation("midnightthoughts", "comfort_negative_macabre"));
    private static final TagKey<Block> NEGATIVE_HOSTILE_TAG = TagKey.create(Registries.BLOCK, new ResourceLocation("midnightthoughts", "comfort_negative_hostile"));
    private static final TagKey<Block> NEGATIVE_DARK_TAG = TagKey.create(Registries.BLOCK, new ResourceLocation("midnightthoughts", "comfort_negative_dark"));
