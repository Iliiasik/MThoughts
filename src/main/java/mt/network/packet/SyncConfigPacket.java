...
public record SyncConfigPacket(
    ...
    public static final CustomPayload.Id<SyncConfigPacket> ID =
            new CustomPayload.Id<>(Identifier.of("midnightthoughts", "sync_config"));

    public static final PacketCodec<RegistryByteBuf, SyncConfigPacket> CODEC = PacketCodec.of(
            (p, buf) -> {
