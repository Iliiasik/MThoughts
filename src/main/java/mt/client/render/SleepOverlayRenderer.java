...
public class SleepOverlayRenderer {
    private static final ResourceLocation IMAGE_TEXTURE = new ResourceLocation(MidnightThoughtsClient.MOD_ID, "textures/gui/moon.png");
    ...
    private void renderImage(GuiGraphics context, int x, int y, int width, int height) {
        ...
        context.blit(IMAGE_TEXTURE, x, y, width, height, 0, 0, IMAGE_ORIGINAL_WIDTH, IMAGE_ORIGINAL_HEIGHT, IMAGE_ORIGINAL_WIDTH, IMAGE_ORIGINAL_HEIGHT);
