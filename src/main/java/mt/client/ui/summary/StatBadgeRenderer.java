...
public class StatBadgeRenderer {
    ...
    private static void renderBadge(GuiGraphics context, Font textRenderer,
        ...
        ResourceLocation badgeTex = SummaryConstants.getStatBadgeTexture();
        RenderSystem.setShader(GameRenderer::getPositionTexShader);
        RenderSystem.setShaderTexture(0, badgeTex);
        RenderSystem.setShaderColor(1.0f, 1.0f, 1.0f, fadeAlpha);
        RenderSystem.enableBlend();
        context.blit(badgeTex, x, renderY, renderW, renderH, 0, 0, texW, texH, texW, texH);
        ...
        RenderSystem.setShaderColor(1.0f, 1.0f, 1.0f, fadeAlpha);
        RenderSystem.enableBlend();
        context.blit(icon, x + padX, iconY, iconSize, iconSize, 0, 0, iconSize, iconSize, iconSize, iconSize);
        RenderSystem.setShaderColor(1.0f, 1.0f, 1.0f, 1.0f);
        RenderSystem.disableBlend();
