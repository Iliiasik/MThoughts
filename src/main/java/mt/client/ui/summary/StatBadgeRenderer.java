...
public class StatBadgeRenderer {
    ...
    public static int render(GuiGraphics context, Font textRenderer, DailySummaryPacket.PlayerDailySummary player,
        ...
        String blocksText = Component.translatable("midnightthoughts.summary.blocks").getString() + " " + NumberFormatter.formatLargeNumber(animBlocks);
        String distanceText = Component.translatable("midnightthoughts.summary.distance").getString() + " " + NumberFormatter.formatLargeNumber(animDistance);
        String mobsText = Component.translatable("midnightthoughts.summary.mobs").getString() + " " + NumberFormatter.formatLargeNumber(animMobs);
        String deathsText = Component.translatable("midnightthoughts.summary.deaths").getString() + " " + NumberFormatter.formatLargeNumber(animDeaths);
        String jumpsText = Component.translatable("midnightthoughts.summary.jumps").getString() + " " + NumberFormatter.formatLargeNumber(animJumps);
